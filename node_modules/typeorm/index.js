        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new ConnectionOptionsReader_1.ConnectionOptionsReader().get("default")];
                case 1:
                    options = _a.sent();
                    _a.label = 2;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    options = _a.sent();
                    _a.label = 2;
                case 2: return [2 /*return*/, Promise.all(options.map(function (options) { return getConnectionManager().create(options).connect(); }))];
            }
        });
    });
}
