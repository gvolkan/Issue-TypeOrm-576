...
var SubjectOperationExecutor = (function () {
    ...
    // Constructor
    // -------------------------------------------------------------------------
    function SubjectOperationExecutor(connection, transactionEntityManager, queryRunner) {
    ...
    SubjectOperationExecutor.prototype.execute = function (subjects) {
        return __awaiter(this, void 0, void 0, function () {
            var isTransactionStartedByItself, broadcaster, error_1, rollbackError_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 16, , 21]);
                        if (!!this.queryRunner.isTransactionActive) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, broadcaster.broadcastBeforeEventsForAll(this.transactionEntityManager, this.insertSubjects, this.updateSubjects, this.removeSubjects)];
                    case 4:
                        _a.sent();
                    ...
                    case 11:
                        _a.sent();
                        if (!(isTransactionStartedByItself === true)) return [3 /*break*/, 13];
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, broadcaster.broadcastAfterEventsForAll(this.transactionEntityManager, this.insertSubjects, this.updateSubjects, this.removeSubjects)];
                    case 15:
                        // finally broadcast "after" events
                        // note that we are broadcasting events after commit because we want to have ids of the entities inside them to be available in subscribers
                        _a.sent();
                    ...
                    case 16:
                        error_1 = _a.sent();
                        if (!isTransactionStartedByItself) return [3 /*break*/, 20];
                        _a.label = 17;
                    case 17:
