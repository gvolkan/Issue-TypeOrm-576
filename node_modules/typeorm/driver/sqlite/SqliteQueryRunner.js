...
var SqliteQueryRunner = (function () {
     ...
     */
    SqliteQueryRunner.prototype.connect = function () {
     ...
     * Starts transaction.
     */
    SqliteQueryRunner.prototype.startTransaction = function () {
                    ...
                    case 1:
                        ...
                        databaseConnection.all(query, parameters, function (err, result) {
                            if (err) {
                                ...
                                _this.driver.connection.logger.logQueryError(err, _this);
                                fail(err);
                            }
                            else {
                                ok(result);
     ...
     */
    SqliteQueryRunner.prototype.stream = function (query, parameters, onEnd, onError) {
     ...
     */
    SqliteQueryRunner.prototype.dropColumn = function (table, column) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    SqliteQueryRunner.prototype.dropColumns = function (table, columns) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SqliteQueryRunner.prototype.enableSqlMemory = function () {
     ...
     */
    SqliteQueryRunner.prototype.disableSqlMemory = function () {
        this.sqlsInMemory = [];
        this.sqlMemoryMode = false;
    };
    /**
     ...
     */
    SqliteQueryRunner.prototype.getMemorySql = function () {
