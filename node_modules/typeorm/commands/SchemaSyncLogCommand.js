 ...
 */
var SchemaSyncLogCommand = (function () {
    function SchemaSyncLogCommand() {
        this.command = "schema:sync";
        this.describe = "Shows sql to be executed by schema:sync command. It shows schema:sync log only for your default connection. " +
            "To run update queries on a concrete connection use -c option.";
    }
    SchemaSyncLogCommand.prototype.builder = function (yargs) {
        return yargs
            .option("c", {
            alias: "connection",
            default: "default",
    ...
    SchemaSyncLogCommand.prototype.handler = function (argv) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, connectionOptionsReader, connectionOptions, sqls, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.logSyncSchema()];
                    case 4:
                        sqls = _a.sent();
    ...
    return SchemaSyncLogCommand;
}());
exports.SchemaSyncLogCommand = SchemaSyncLogCommand;

//# sourceMappingURL=SchemaSyncLogCommand.js.map
