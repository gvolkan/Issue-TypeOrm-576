...
var SchemaSyncCommand = (function () {
    ...
    SchemaSyncCommand.prototype.handler = function (argv) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, connections, connectionOptionsReader, connectionOptions, connectionOptions, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        connection = _a.sent(); // process.cwd()
                        return [4 /*yield*/, connection.syncSchema(false)];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 9];
                    case 5: return [4 /*yield*/, connectionOptionsReader.all()];
                    case 6:
                        connectionOptions = _a.sent();
                        return [4 /*yield*/, index_1.createConnections(connectionOptions)];
                    case 7:
                        connections = _a.sent();
                    ...
                    case 12:
                        _a.sent();
                        _a.label = 13;
                    case 13: return [4 /*yield*/, Promise.all(connections.map(function (connection) { return connection.close(); }))];
                    case 14:
                        _a.sent();
                        return [7 /*endfinally*/];
