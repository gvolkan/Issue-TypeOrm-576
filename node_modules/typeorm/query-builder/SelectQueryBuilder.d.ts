 ...
 */
export declare class SelectQueryBuilder<Entity> extends QueryBuilder<Entity> {
    /**
    ...
    protected executeCountQuery(options: {
        release: boolean;
    }): Promise<number>;
    /**
     * Executes sql generated by query builder and returns object with raw results and entities created from them.
     */
    protected executeEntitiesAndRawResults(options: {
        release: boolean;
    }): Promise<{
        entities: Entity[];
        raw: any[];
